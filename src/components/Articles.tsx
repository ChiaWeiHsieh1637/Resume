...
const Articles: React.FC = () => {
  ...
  const articles: Article[] = [
    {
      id: 12,
      title: '升 Senior 修煉清單：從工程師到技術決策者的自我進化',
      description: '分享軟體工程師成長為資深工程師的關鍵技能與思維轉變，不只是技術精進，更需要系統觀、溝通力與主人翁心態。',
      date: '2025-05-24',
      link: 'https://example.com/article12',
      tags: ['職涯發展', '軟體工程', '技術領導', '自我成長'],
      content: `
        <h2>在每一位軟體工程師的成長旅途中，總有那麼一個時期</h2>
        <p>開始意識到：光是會寫程式，已經不夠了。當年初入職場，抱著解 bug、交任務、破關升等的心態，總以為只要技術夠強，遲早會被看見。但當你開始參與專案規劃、跨部門溝通，甚至負責部署與後續維運時，你會驚覺：真正讓一位工程師進化為 Senior 的，從來不只是「寫得多」，而是「懂得多」與「負責更多」。</p>
        
        <p>這是一份從我自身經驗與觀察中提煉出來的「升 Senior 修煉清單」，不為打怪而戰，只為讓你走得更穩、更深、更遠。</p>
        
        <h2>一、技術是根：從「我會寫」走向「我能設計」</h2>
        <p>Senior 工程師不僅要能獨立開發，更應該具備對技術架構的思考能力。他寫的不再是「能跑」的程式碼，而是團隊未來半年都能維護、理解與擴充的系統。這裡的重點不在於炫技，而是可讀性、模組化與測試性。</p>
        
        <ul>
          <li>精通主力語言與框架不是終點，是起點。</li>
          <li>理解事件迴圈、非同步機制與資源管理，是基本功。</li>
          <li>設計模組時，能思考邊界、耦合與未來擴充空間，是能力的展現。</li>
        </ul>
        
        <h2>二、眼界要開：從「寫功能」升級到「解脈絡」</h2>
        <p>Junior 常常看到 ticket 就直接開工，但 Senior 知道，一張任務背後可能牽動的是商業邏輯、資料流程甚至客戶體驗。他們會問：「這功能為什麼重要？最終目標是什麼？有沒有更簡潔的方法達成？」</p>
        
        <ul>
          <li>他們主動釐清需求，而非被動接受指令。</li>
          <li>他們會去找舊的 PR、設計文檔、測試紀錄，拼湊全貌。</li>
          <li>他們懂得平衡工程最佳解與商業現實。</li>
        </ul>
        
        <h2>三、系統觀強：從「功能模組」看見「整體架構」</h2>
        <p>寫 API 很簡單，寫對全系統都穩健的 API 很難。Senior 不只是 code owner，更是 system owner。他們看重效能、部署策略、可觀測性與災難處理。他們知道系統不是單靠程式語法撐起來的，而是靠對資料流、使用場景與限制的理解。</p>
        
        <ul>
          <li>他們懂 DB index、SQL 調校，也了解 cache、queue、rate limit。</li>
          <li>他們能與 DevOps 合作，設計 CI/CD pipeline，確保快速又安全的部署流程。</li>
          <li>他們考慮災難復原機制，也知道怎麼 rollback、feature flag。</li>
        </ul>
        
        <h2>四、溝通不怕：能寫，也能說，更能聽懂別人說什麼</h2>
        <p>升為 Senior 的過程中，有一項技能尤其容易被忽略：溝通。能清楚解釋自己的設計、能給出具體的 code review 意見，甚至能與非技術角色對話，是一位資深工程師不可或缺的能力。</p>
        
        <ul>
          <li>他們在 PR 說明中不是寫「fix bug」，而是清楚描述問題根因與處理手法。</li>
          <li>他們能站在 PM 或設計師的角度，理解需求背後的意圖。</li>
          <li>他們願意指導後進，建立知識傳承與團隊默契。</li>
        </ul>
        
        <h2>五、主動而負責：技術只是手段，擁有主人翁心態才是關鍵</h2>
        <p>Senior 不一定寫最多的 code，但他一定是那個「負得起責任」的人。他不會只在意今天能不能 merge，而是關心這段 code 三個月後能不能用。他看見技術債，不是抱怨，而是提出改善。他不是主管，但他是團隊中自然被信任的角色。</p>
        
        <ul>
          <li>他主動監看系統健康，甚至設定告警。</li>
          <li>他在專案 kick-off 時就開始思考未來風險。</li>
          <li>他有原則，不因趕時程就犧牲品質；也有彈性，知道什麼時候該放手。</li>
        </ul>
        
        <h2>結語：你可以選擇只當一名執行者，也可以選擇成為一位技術領航者</h2>
        <p>Senior 並不神秘，他只是那個願意多想一步、多做一點的人。他是那種遇到問題不會只說「這不是我負責的」，而會說「讓我看看怎麼解決」的人。他不是完美無缺，但他總是比昨天更清楚、比上次更穩健。他知道，程式碼會變老，技術會過時，但對系統、對人、對團隊的責任感，會讓他走得更遠、更自由。</p>
        
        <p>如果你也正走在這條路上，這份修煉清單不是用來評分的尺，而是一把照見方向的光。願我們都能在工程之路上，不只是寫程式的人，而是解決問題的人。</p>
      `
    },
    {
      id: 11,
